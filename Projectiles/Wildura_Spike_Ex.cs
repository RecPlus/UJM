...
{
	public class Wildura_Spike_Ex : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Wildura Spike EX");     //The English name of the projectile
		}
		...
		public override void SetDefaults()
		{
			...
			projectile.height = 30;              //The height of projectile hitbox          //The ai style of the projectile, please reference the source code of Terraria
			projectile.friendly = true;         //Can the projectile deal damage to enemies?
			projectile.hostile = false;         //Can the projectile deal damage to the player?
			projectile.magic = true;           //Is the projectile shoot by a ranged weapon?
			projectile.penetrate = 3;           //How many monsters the projectile can penetrate. (OnTileCollide below also decrements penetrate for bounces as well)         //The live time for the projectile (60 = 1 second, so 600 is 10 seconds)
        ...
        {
			 if (Main.rand.NextFloat(6) < 1)
		    target.AddBuff (70, 300);    //this adds the buff to the npc that got hit by this projectile , 600 is the time the buff lasts
        }
